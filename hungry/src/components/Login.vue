 ...
 * @LastEditors: 熊小兜
 * @LastEditTime: 2019-11-12 10:35:27
 * @Description: 
 -->
<template>
    <div class="box">
        ...
        <div class="input-group">
            <p>新用户登录即自动注册，并表示已同意 
             《用户服务协议》和《隐私权政策》 </p>
            <input type="button" value="登录" class="DL"  @click="loginCheck">
        </div>
        <p class="reg">还没有注册的宝宝们，
			<router-link to="/Registerpage">请立即注册</router-link></p>
    </div>
</template>
<script>
